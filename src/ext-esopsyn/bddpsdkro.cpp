...
void BddPSDKRO(DdNode* pNode, int& Cost, std::vector<std::string>& Esop){
    ...
    BddPSDKRO(p0, Cost0, Esop0);
    Cudd_RecursiveDeref(dd, p0);

    BddPSDKRO(p1, Cost1, Esop1);
    Cudd_RecursiveDeref(dd, p1);

    BddPSDKRO(p01, Cost01, Esop01);
