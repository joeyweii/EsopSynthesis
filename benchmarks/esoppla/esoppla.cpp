...
int main(int argc, char* argv[]){
    ...
    OutFile << "# Cube number before expansion: " << C_final.size() << endl;
    OutFile << "# Cube number after expansion: " << Cs_final.size() << endl;
    OutFile << "#############" << endl;
    ...
    for(int i = 0; i < Cs_final.size(); i++){
        for(int j = 0; j < Cs_final[i].size(); j++){
            OutFile << Cs_final[i][j];
        }
        OutFile << " 1" << endl;
    }
